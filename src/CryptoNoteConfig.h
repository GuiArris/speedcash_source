...
// Copyright (c) 2024, The SpeedCash Team.
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 282776;
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 17;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 60 * 60 * 2;

const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 60;

const uint64_t MONEY_SUPPLY                                  = UINT64_C(58754500000000);
const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX                   = 0;
const size_t ZAWY_DIFFICULTY_V2                              = 0;
const uint8_t ZAWY_DIFFICULTY_DIFFICULTY_BLOCK_VERSION       = 1;
const unsigned EMISSION_SPEED_FACTOR                         = 21;
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(11163300000000);
...
const char     CRYPTONOTE_NAME[]                             = "speedcash";
...
const int      P2P_DEFAULT_PORT                              =  27770;
const int      RPC_DEFAULT_PORT                              =  27771;
...
const char* const SEED_NODES[] = { "main01.getspeedcash.org:27770", "main02.getspeedcash.org:27770" };
} // CryptoNote
